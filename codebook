...
2. Assign each data to variables
   a)`features <- features.txt` :The features selected for this database come from the accelerometer and gyroscope 3-axial raw signals tAcc-XYZ and tGyro-XYZ.
   b)`activities <- activity_labels.txt` : List of activities performed when the corresponding measurements were taken and its codes (labels)
